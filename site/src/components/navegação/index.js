...
export default function navegar() {
    ...
    return (
       <Containernavegador>
            ...
            <div className="sub">
                <div className="barra" style={{marginTop: '3px'}}> <img src="/assets/images/Rectangle 14.svg" alt="" /> </div>
                <div style={{margin: '0px 0px 0px 70px', fontWeight: '500', fontSize: '18px' }}>Alunos</div>    
            </div>
       </Containernavegador>
    )
}